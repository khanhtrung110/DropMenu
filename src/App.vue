<template>
  <div class="container">
    ...
    <div class="select-box">
      ...
      <div class="selected"><span> <img src="../src/assets/hehe.png" alt="">
          <input type="radio" class="radio" id="all" name="category" />
          <label for="all">all-img</label>
    ...
    <div class="modal">
      ...
      <p>
        ...
        beatae illo error sapiente sunt labore quam nemo porro officia nisi.
      </p>
...
import { defineAsyncComponent, onMounted, reactive, ref, watchEffect } from "@vue/runtime-core";
...
export default {
  ...
  setup() {
    const listSelect =reactive({data:[
      {
        id: 'alls',
        title: 'all-img',
      },
